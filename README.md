...
- [Section 4: How AnimalMotionViz works and its application](#section-4)
  ...
  - [4.2: Guidelines on setting up the video processing parameters](#section-4-2)
    ...
    - [4.2.6:  Select a threshold value to filter detected motions for core and full range calculations](#section-4-2-6)
    - [4.2.7:  Choose the overlay parameters](#section-4-2-7)
...
#### 4.2.6 Select a threshold value to filter detected motions for core and full range calculations <a name="section-4-2-6"></a>
...
#### 4.2.7 Choose the overlay parameters <a name="section-4-2-7"></a>
...
#### 4.2.8 Select a colormap <a name="section-4-2-8"></a>
...
#### 4.2.9 Start the video processing<a name="section-4-2-9"></a>
...
### 5.1 Motion heatmap image, core and full-range image, and video <a name="section-5-1"></a>
...
- **Core Range:** This metric quantifies the area, in pixels, where the highest concentration of movement occurs within the frame. It represents the most frequently used area and is calculated based on the density of detected motion.
  
- **Full Range:** This metric indicates the total area, in pixels, where movement is detected across the entire frame. It encompasses the space used for nearly all detected movement, providing a comprehensive view of the area’s overall activity.
